...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) //It allows usage of BeforeAll and AfterAll. Default is PER_METHOD
public class ECertisClientWiremockTests {

    static WireMockServer wm;
    ECertisClient eCertisClient = new ECertisClient(true);
